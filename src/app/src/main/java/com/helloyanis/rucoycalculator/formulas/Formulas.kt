...
val mobs = arrayOf(
    Mob("Rat Lv.1", "<:1_rat:781390912248348683>", 4, 25,1),
    Mob("Rat Lv.3", "<:3_rat:781390923753717781>", 7, 35,3),
    Mob("Crow Lv.6", "<:6_crow:781390951191937024>", 13, 40,6),
    Mob("Wolf Lv.9", "<:9_wolf:781390959735996436>", 17, 50,9),
    Mob("Scorpion Lv.12", "<:12_scorpion:781390969824215052>", 18, 50,12),
    Mob("Cobra Lv.13", "<:14_cobra:781390978988507158>", 18, 50,13),
    Mob("Worm Lv.14", "<:14_worm:781390986614014004>", 19, 55,14),
    Mob("Goblin Lv.15", "<:15_goblin:781390994376622140>", 21, 60,15),
    Mob("Mummy Lv.25", "<:25_mummy:781391003780513813>", 36, 80,25),
    Mob("Pharaoh Lv.35", "<:35_pharaoh:781391013591253063>", 51, 100,35),
    Mob("Assassin Lv.45", "<:45_assassin:781391026727682051>", 71, 120,45),
    Mob("Assassin Lv.50", "<:50_assassin:781391034990460958>", 81, 140,50),
    Mob("Assassin Ninja Lv.55", "<:55_ninja_assassin:781391057128390696>", 91, 160,55),
    Mob("Skeleton Archer Lv.80", "<:80_skeleton_archer:781391133023928359>", 101, 300,80),
    Mob("Zombie Lv.65", "<:65_zombie:781391115181228069>", 106, 200,65),
    Mob("Skeleton Lv.75", "<:75_skeleton:781391124929314827>", 121, 300,75),
    Mob("Skeleton Warrior Lv.90", "<:90_skeleton_warrior:781391140691771393>", 146, 375,90),
    Mob("Vampire Lv.100", "<:100_vampire:781391148982730763>", 171, 450,100),
    Mob("Vampire Lv.110", "<:110_vampire:781391156671807508>", 186, 530,110),
    Mob("Drow Ranger Lv.125", "<:120_drow_ranger:781391163743010867>", 191, 600,125),
    Mob("Drow Mage Lv. 130", "<:130_drow_mage:781391184470867968>", 191, 600,130),
    Mob("Drow Assassin Lv.120", "<:125_drow_assassin:781391173088575488>", 221, 620,120),
    Mob("Drow Sorceress Lv.140", "<:140_drow_sorceress:781391206755336222>", 221, 600,140),
    Mob("Drow Fighter Lv.135", "<:135_drow_fighter:781391196534472705>", 246, 680,135),
    Mob("Lizard Archer Lv.160", "<:160_lizard_archer:781391233582497793>", 271, 650,160),
    Mob("Lizard Shaman Lv.170", "<:170_lizard_shaman:781391275177672715>", 276, 600,170),
    Mob("Dead Eyes Lv.170", "<:170_dead_eyes:781391266923020309>", 276, 600,170),
    Mob("Lizard Warrior Lv.150", "<:150_lizard_warrior:781391223604117534>", 301, 680,150),
    Mob("Djinn Lv.150", "<:150_djinn:781391214833303562>", 301, 640,150),
    Mob("Lizard High Shaman Lv.190", "<:190_lizard_high_shaman:781391314947538944>", 326, 740,190),
    Mob("Gargoyle Lv.190", "<:190_gargoyle:781391298598010892>", 326, 740,190),
    Mob("Dragon Hatchling Lv. 240", "<:240_dragon_hatchling:781391338758471690>", 331, 10000,240),
    Mob("Lizard Captain lv.180", "<:180_lizard_captain:781391284002488370>", 361, 815,180),
    Mob("Dragon Lv.250", "<:250_dragon:781391347922894849>", 501, 20000,250),
    Mob("Minotaur Lv.225", "<:225_minotaur:781391328763314187>", 511, 4250,225),
    Mob("Minotaur Lv.250", "<:250_minotaur:781391355561246752>", 601, 5000,250),
    Mob("Dragon Warden Lv.280", "<:280_dragon_warden:781391390575165450>", 626, 30000,280),
    Mob("Ice Elemental Lv.300", "<:300_ice_elemental:781391399709835267>", 676, 40000,300),
    Mob("Minotaur Lv.275", "<:275_minotaur:781391363476291597>", 691, 5750,275),
    Mob("Ice Dragon Lv.320", "<:320_ice_dragon:781391412217249823>", 726, 45000,320),
    Mob("Yeti Lv.350", "<:350_yeti:781391428030431262>", 826, 55000,350)
)
...
class Mob(val mob_name: String, val emoji_code: String, val mob_defense: Int, val mob_health: Int, val mob_level: Int) {
}
